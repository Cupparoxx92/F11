...
# Nome do arquivo de movimentações
...
# Variável para armazenar o resumo da última movimentação
resumo_movimentacao = ""

# ————————————————————————————————————————————
if menu == "Movimentação":
    st.header("Movimentação de Ferramentas")
...
# Fora do formulário — Botão de download aparece após a movimentação
if resumo_movimentacao:
    st.subheader("Resumo para Impressão")
...
# ————————————————————————————————————————————
    ...
    st.header("Cadastro de Ferramentas")
    st.info("Página em construção.")
